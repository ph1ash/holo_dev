...
public class GestureManager : Singleton<GestureManager>
{
    ...
    public GameObject ObjectStartedOn { get; private set; }
    ...
    private void NavigationRecognizer_NavigationStartedEvent(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
    {
        ...
        if (GazeManager.Instance.HitInfo.collider.gameObject != null)
        {
            ObjectStartedOn = GazeManager.Instance.HitInfo.collider.gameObject;
            Debug.Log("StartedOn = " + ObjectStartedOn.name);
        }
        else
            ObjectStartedOn = null;
    }
    ...
    private void NavigationRecognizer_TappedEvent(InteractionSourceKind source, int tapCount, Ray ray)
    {
        ...
        {
            Debug.Log("Tapped Object = " + focusedObject.name);
